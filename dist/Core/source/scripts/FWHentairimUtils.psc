ScriptName FWHentairimUtils hidden
...
Bool Function isAnimationHentairimTagged (sslBaseAnimation animation , int stage , Int pos) Global
    ...
    String EMPTYTAG = "LDI"
    String penetrationLabel = FWHentairimUtils.PenetrationLabel(animation, stage, pos)
    String oralLabel = FWHentairimUtils.OralLabel(animation, stage, pos)
    String stimulationLabel = FWHentairimUtils.StimulationLabel(animation, stage, pos)
    String endingLabel = FWHentairimUtils.EndingLabel(animation, stage, pos)
    String penisActionLabel = FWHentairimUtils.PenisActionLabel(animation, stage, pos)
